 ...
 *
 *   hidden(caller) = | extraAppList | (union of templates[*].appList) |, minus
 * xj.a
 *
...
public:
  ...
  [[nodiscard]] static std::optional<HmaPolicy>
...
private:
  ...
  string_set(const nlohmann::json &object, std::string_view key);
};
